...
config :investor_app, InvestorAppWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "ToMM0wNCxVjpf446I+nx9N4E2BDo9K8H9iDT3nOs+/EX788C1bHolMuZYnPZuVeP",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:investor_app, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:investor_app, ~w(--watch)]}
  ]
...
config :investor_app, InvestorAppWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/investor_app_web/router\.ex$",
      ~r"lib/investor_app_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :investor_app, dev_routes: true
